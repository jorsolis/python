...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 17:10:32 2020
...
#                     st.exponweib,st.exponpow,st.f,st.fatiguelife,st.fisk,
                     st.foldcauchy,
#                     st.foldnorm,st.frechet_r,st.frechet_l,
...
#                     st.uniform,st.vonmises,st.vonmises_line,st.wald,
...
if __name__ == '__main__':
    ...
    ax = data.plot(kind='hist', bins=50, alpha=0.5, density=True)#, color=plt.rcParams['axes.color_cycle'][1])
    # Save plot limits
