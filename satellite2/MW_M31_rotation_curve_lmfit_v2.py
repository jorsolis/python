...
MO = {'rlam' : [0.001, 0.1, 0.02], 'mu' : [1.556, 155.6,  15.5655], 
      ...
      'BH' : [1e-4, 1e-3, .00037]} #### no extrapolar DM
...
rlamu, muu, Mdu, adu, Mbu, bbu, Mbiu, bbiu, MBHu = popt_up
rlamd, mud, Mdd, add, Mbd, bbd, Mbid, bbid, MBHd = popt_dw

y_min= func(r, rlamd, mud, Mdd, add, Mbd, bbd, Mbid, bbid, MBHd)
y_max= func(r, rlamu, muu, Mdu, adu, Mbu, bbu, Mbiu, bbiu, MBHu)
