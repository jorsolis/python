...
import numpy as np
#
from resolvedor import solver_green2,solver_green
#####   Constantes    ############################################
mu = 15637.8 # en 1/kpc
c = 0.3  # kpc/kyear
Mmw = 0.000005  #kpc
...
#solver_green(u0,uf,du,y0,ncor,'LSODA',L,labco % co,'green2',
#             'esf/fullnum',plot3d=True)
solver_green2(u0,uf,du,y0,ncor,'LSODA',L,b,labco % co,'green',
             'esf/fullnum',plot3d=True)
