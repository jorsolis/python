...
con miyamoto con Rc y con todos los parametros uniform
...
############## 1
#MO = {'Rc' : [0.05, 6., 1.5], 'Mc' : [0.50, 5.5, 1.6], 're' : [0.10, 4., 1.3],
#      'rs' : [0.05, 40., 4.5], 'Md' : [0.00, 5.,  1.0], 'ad' : [0.00, 10.,5.0],
#      'bd' : [0.10, 0.80, 0.2], 'Mb' : [0.00, 3.5, 1.0], 'bb' : [0.00, 1., 0.25]}
############## 2
#MO = {'Rc' : [0.05, 5.,1.5], 'Mc' : [0.50, 14.,1.6],
#      're' : [0.10, 12., 1.3], 'rs' : [0.05, 40., 8.5], 
#      'Md' : [0.00, 5.,  1.0], 'ad' : [0.00, 10.,5.0], 'bd' : [0.10, 0.90, 0.2],
#      'Mb' : [0.00, 3.5, 1.0], 'bb' : [0.00, 1., 0.25]}
############ 3
#MO = {'Rc' : [0.05, 7., 4.3], 'Mc' : [0.50, 14., 6.],
#      're' : [0.10, 12., 6.], 'rs' : [0.0, 85., 20.], 
#      'Md' : [0.00, 6.,  1.0], 'ad' : [0.00, 20., 5.],'bd' : [0.0001, 0.90, 0.15],
#      'Mb' : [0.00, 3.5, 1.3], 'bb' : [0.00, 1., 0.35]}
############ 4
#MO = {'Rc' : [0.05, 7., 4.3], 'Mc' : [0.50, 14., 6.],
#      're' : [0.10, 12., 6.], 'rs' : [0.0, 105., 20.], 
#      'Md' : [0.00, 15., 4.0], 'ad' : [0.00, 25., 4.],'bd' : [0.0001, 20.90, 0.15],
#      'Mb' : [0.00, 3.5, 1.3], 'bb' : [0.00, 1., 0.35]}
############ 5
#MO = {'Rc' : [0.05, 7., 4.3], 'Mc' : [0.50, 14., 6.],
#      're' : [0.10, 12., 6.], 'rs' : [0.0, 110., 56.], 
#      'Md' : [0.00, 40., 15.0], 'ad' : [0.00, 40., 4.],'bd' : [0.01, 40.90, 0.15],
#      'Mb' : [0.00, 3.5, 1.3], 'bb' : [0.00, 1., 0.35]}
############ 6
#MO = {'Rc' : [0.05, 7., 4.3], 'Mc' : [0.50, 14., 6.],
#      're' : [0.10, 12., 6.], 'rs' : [0.0, 110., 56.], 
#      'Md' : [0.00, 60., 30.0], 'ad' : [0.00, 60., 4.],'bd' : [0.01, 40.90, 0.15],
#      'Mb' : [0.00, 3.5, 1.3], 'bb' : [0.00, 1., 0.35]}
...
############ 8
MO = {'Rc' : [0.001, 2., 1.], 'Mc' : [0.0001, 1000., 8.], 
      're' : [0.0001, 1., 0.001], 'rs' : [0.0001, 600., 2.], 
