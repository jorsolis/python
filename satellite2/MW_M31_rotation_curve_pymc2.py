...
def fit_mcmc(rad, v, v_error, MO, nsamples = 1000):
    namep =   [r'$\lambda$', r'$\mu$', r'$M_d$', r'$a_d$',
              r'$M_b$',r'$b_b$', r'$M_{BH}$']    
...
if __name__ == '__main__':
    nsam = 1e5
    MO = {'lamb' : [1e-7, 1.,  3.0e-3], 'mu' : [1.556, 156.550,  15.5655],
          'Md' : [1e-5, 30., 5.0], 'ad' : [10., 100., 20.],'bd' : [.1, 3., 1.15],
...
#    rlam, mu, Md, ad, bd, Mb, bb, Mbh = np.load('%s/params.npy'%(dirfits))
    ...
    pts.plotmultiple([rad, r, r, r, r,r ], [fit, np.sqrt(vdisk**2 + vbulge**2), 
                     ...
                     [r'Disk+Bulge+multiSFDM', r'Disk+Bulge',
                     ...
                     'multiSFDM $\Phi_{100} + \Phi_{%d%d%d}$'%(n, l, m), 
                     '%s/DM_fit2_ncor_%d_2.png'%(dirfits,ncor),
#                     ylim = (0,360), 
#                     xlim = (0, rmax),
                     logx =True, logy=True,
