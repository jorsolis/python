...
from pot_paco_orbitas_analisis import (mptodos, filtro,
                               mptodos_plot, mptodos_l, mptodos_plot_l)
...
#carp = 'orbitas_disc_dist_new2' #otras particulas iniciales
...
#    mptodos_l(nsol,te= i,carp = carp,rut = rut, de=di, kmax=1)
